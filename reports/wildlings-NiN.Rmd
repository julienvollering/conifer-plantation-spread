...
Important note: the following tables count the number of wildlings by the polygons that they intersect. As a result, wildlings occurring in mosaics (overlapping polygons) are counted more than once!
...
localities <- mutate(localities, age.at.registration = case_when(
  locality == "Haakoeya" & species == "P.sitchensis-lutzii" ~ HaakoeyaAge,
