...
raster::writeRaster(ras, here("output","broervika","adWALD.tif"), overwrite=TRUE)
...
grd[, "density"] <- src.mat[1:length(src.mat)]
ras <- raster::rasterize(as(grd, "Spatial"), ras, field="density")
raster::writeRaster(ras, here("output","broervika","aiWALD.tif"), overwrite=TRUE)
...
grd[, "density"] <- src.mat[1:length(src.mat)]
ras <- raster::rasterize(as(grd, "Spatial"), ras, field="density")
raster::writeRaster(ras, here("output","broervika","ExP.tif"), overwrite=TRUE)
...
grd[, "density"] <- src.mat[1:length(src.mat)]
ras <- raster::rasterize(as(grd, "Spatial"), ras, field="density")
raster::writeRaster(ras, here("output","broervika","LogS.tif"), overwrite=TRUE)
