...
3. "left_join" independentVars to hgtclasses (x2) (see *add_wildlings* function)
4. save as list with species at first level, followed by height classes at lower level
