...
st_write(poi, here("data", "raw", "eKlima", "POI-windst.csv"), 
...
```{r latlong to Met}
loc <- read_csv(here("data", "raw", "eKlima", "POI-windst.csv")) %>% 
...
ggplot() +
  geom_sf(data = nor) + 
  geom_sf(data = loc, color = "black")

write_csv(here("data", "raw", "eKlima", "POI-latlon.csv"))
```
