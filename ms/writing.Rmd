...
4. How much of the total variation in wildling abundance can be explained by a combination of location, age, and surroundings? 
...
Plantations of non-native conifers are widespread in Norway, as they are in many countries, and offspring from these plantations frequently establish in surrounding areas [@richardson2004].
...
Norway has only two native conifer species that form forests (Scots pine, *Pinus sylvestris* and Norway spruce, *Picea abies*), so efforts in the 20th century to increase forest cover relied heavily on exotic species [@oyen2017]. 
