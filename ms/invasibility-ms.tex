...
For example, low establishment likelihood in an ecosystem frequently located close to plantations can be masked by copious seed rain (Rouget \& Richardson, \protect\hyperlink{ref-rougetInferringProcessPattern2003}{2003}).
...
\caption{\label{fig:sites-map}Locations of the 82 plantation stands in the sample.}
\end{figure}
...
We reiterate that our models do not estimate climate's total causal effect on wildling abundance, because they set aside its influence on ecosystems (Westreich \& Greenland, \protect\hyperlink{ref-westreichTableFallacyPresenting2013}{2013}).
