...
To estimate the causal influence of ecosystems on wildling abundance in accordance with the DAG (McElreath \protect\hyperlink{ref-mcelreathHauntedDAGCausal2020}{2020}, Textor et al. \protect\hyperlink{ref-textorRobustCausalInference2016}{2016}), we modeled the count process as dependent on ecosystem, site, climate, elevation from the plantation, and relative seed rain.
