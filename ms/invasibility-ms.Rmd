...
The first analysis simply tallied of the number of wildlings of each conifer per unit area of each nature type.
...
In the tallying analysis, variation in the density of wildlings is partly attributable to differences between conifers and between nature types, and partly to contingent factors, such as the spatial distribution of nature types around plantations. 
The motivation for this approach was descriptive: to break down the realised spread of wildlings at the specific localities in the data set.

The second analysis modeled the number of wildlings per unit area... 
