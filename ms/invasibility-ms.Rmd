...
We parameterized separate WALD models for 20-degree sectors around seed sources, to make seed dispersal anisotropic.
In each sector we estimated vegetation height based on the composition of mapped ecosystem types (Appendix [A2]), and randomly sampled 100 wind velocities from all measurements with that direction.
The seed probability density in the sector was obtained by summing the estimates of the 100 resulting WALD kernels. 
We combined all sectors around a source, weighted by the frequency distribution of wind directions during the species' dispersal season (Appendix [A3]).
