...
To estimate how ecosystem type affects wildlings, the directed acyclical graph guided us to specify a statistical model with climate, relative elevation, seed deposition density, locality, and plantation age as covariates [@textorRobustCausalInference2016; @mcelreathHauntedDAGCausal2020].
...
We represented climate with variables for mean annual temperature (bio1) and precipitation of the coldest quarter (bio19) from the CHELSA data product [@kargerClimatologiesHighResolution2017].
