...
2. We compared how likely wildlings are to establish in different ecosystems, studying three groups of alien conifer species in Norway. We used data from detailed surveys around 76 plantation stands to model the relationship between ecosystem type and wildling abundance, accounting for seed rain (estimated), climate, and other sources of variation between sites.
3. We found that relative establishment likelihood spanned at least three orders of magnitude between the most and least susceptible ecosystems. Agricultural ecosystems were among the least susceptible to any of the alien conifer species. We also found that surveyed wildling densities (abundance/area) were poorly correlated with susceptibility to wildling establishment (expected wildling abundance, all else being equal), because ecosystems were unequally exposed.
