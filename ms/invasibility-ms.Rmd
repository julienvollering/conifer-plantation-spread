...
&RelativeElevation_{ij} + PlantationAge_{ij} + \\
...
Estimated establishment likelihoods varied by up to five orders of magnitude among ecosystems (fig. \@ref(fig:establishment)).
...
kbl(cortab, booktabs = TRUE,
    caption = "Rank correlations of relative establishment likelihoods in ecosystem types, between pairs of species groups.") %>%
  kable_styling(full_width = F)
```

Wildling densities across all ecosystems ranged 0-211/ha for Sitka spruce (unstratified mean: 28), 0-49/ha for Norway spruce (unstratified mean: 6), 0-1045/ha for larches (unstratified mean: 13), and 0-219/ha for lodgepole pine (unstratified mean: 34).
Relative establishment likelihoods varied more than the corresponding set of densities, in all species (fig. \@ref(fig:establishment), Appendix table \@ref(tab:dispersion-table)).
The ranking of ecosystems by establishment likelihood also differed from their ranking by wildling density.
For instance, Sitka/Lutz spruce showed higher densities in "artificial substrate" than "boreal heath", but was more likely to establish in "boreal heath".
...
However, managers should be cautious judging ecosystem vulnerability based on descriptions of the species' autecology, wildling densities, or generalizations about vulnerability across ecosystems.
...
kable(msumms$`Pa-modelsummary`[,-1], longtable = TRUE, booktabs = TRUE, align = 'lrrrr', 
      caption = "\\label{tab:Pa}Model summary for Picea abies. The conditional submodel is glmmTMB's genpois (Generalized Poisson) family with dispersion parameter phi² = 2.495544") %>%
  add_header_above(c(" " = 1, "Fixed effects" = 2, "Random effects" = 2)) %>% 
  kable_styling(latex_options = "striped") %>% 
...
kable(msumms$`L-modelsummary`[,-1], longtable = TRUE, booktabs = TRUE, align = 'lrrrr', 
      caption = "\\label{tab:L}Model summary for Larix spp. The conditional submodel is glmmTMB's genpois (Generalized Poisson) family with dispersion parameter phi² = 6.713045") %>%
  add_header_above(c(" " = 1, "Fixed effects" = 2, "Random effects" = 2)) %>% 
  kable_styling(latex_options = "striped") %>% 
...
kable(msumms$`Pc-modelsummary`[,-1], longtable = TRUE, booktabs = TRUE, align = 'lrrrr', 
      caption = "\\label{tab:Pc}Model summary for Pinus contorta. The conditional submodel is glmmTMB's genpois (Generalized Poisson) family with dispersion parameter phi² = 68.49936") %>%
  add_header_above(c(" " = 1, "Fixed effects" = 2, "Random effects" = 2)) %>% 
  kable_styling(latex_options = "striped") %>% 
