...
While there is a long history of using alien conifers in forestry, alien conifer plantations are not a thing of the past.
In many parts of the world, commercial forestry relies on alien conifer species [@ref].
...
### We want to prevent spread from plantations
Responsible forestry practice requires that alien species be kept within plantation boundaries [@brunduGlobalGuidelinesSustainable2020]. 
It is prudent to prevent the initial spread from plantations both to protect the integrity of surrounding ecosystems and to block secondary, potentially invasive spread [@nunezEcologyManagementInvasive2017].
Alien conifer plantations generally produce self-sown individuals ("wildlings") outside plantation boundaries, and these may threaten the integrity of existing ecosystems. 
For example, most pine invasions into protected areas in South Africa can be attributed directly to nearby plantations [@mcconnachieEstimatingEffectPlantations2015].
Alien conifer invasions have proven damaging and costly in many parts of the world, so we need ways to prevent spread from plantations into surroundings.

## Part 2: the state of the science, including the narrower subject, region, community and species-specific context

### Wildlings establish in some ecosystems more readily than others
In large measure, the rate at which wildlings establish and grow outside a plantation will depend on the biotic and abiotic conditions there.  
Wildlings will establish and grow more readily in some ecosystems than others, depending on the autecology of the species.
Spatial distributions of wildlings vary from plantation to plantation [@fernandesWhatDrivesEucalyptus2018; @nygaardSpreadIntroducedSitka2017] at least partly because there are differences in the composition and spatial configuration of surrounding ecosystems.
All else being equal, some ecosystems will harbor more wildlings than others.

### What we know about wildlings across ecosystems
Use @nygaardOkologiskOgSkogbruksmessig2021 as an example of *vulnerability* being ahead of *susceptibility* 

### Relative abundance != relative susceptibility
...
- Ecosystem susceptibility in Norway (conifer-poor, like southern hemisphere)
...
### Assess early
It is clear from extensive experience with alien conifer invasions in several parts of the world that control interventions need to be focused on the early stages of invasion [@nunezEcologyManagementInvasive2017].
...
### Assess establishment across management units
