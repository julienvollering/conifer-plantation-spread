...
For our analyses of establishment frequency, we rasterized wildling occurences and polygons of ecosystem types to the same 10 m grid as the seed dispersal models (fig. \@ref(fig:locality-example)). 
Each ecosystem type was rendered separately, in rasters whose values represented the type's proportional area in a given cell.
