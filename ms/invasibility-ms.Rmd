...
we took the natural log of this variable and entered it as an offset term (coefficient fixed at 1) [@zuurMixedEffectsModels2009].
...
Our results do not imply, for example, that a strong anthropogenic disturbance event will decrease establishment likelihood of Sitka/Lutz spruce relative to an ecosystem's prior state Indeed, Vikane et al. [-@vikaneInvasionCallunaHeath2013] show, for example, that burning in coastal heath increases Sitka spruce establishment.
...
JV, SLO, and OSk conceived the ideas and designed methodology; SLO, LA, MOK, AO, JS, OSt, and ØS collected the data; JV analyzed the data and led the writing. All authors contributed to the drafts and gave approval for publication.
