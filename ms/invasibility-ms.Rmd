...
Naturally, the variation in establishment likelihoods shrank when we aggregated ecosystem types (by category or structuring process; fig. \@ref(fig:establishment-hypotheses)).
...
Important! Differences between species partly reflect the composition of ecosystem types in the samples! E.g. open active landslide pulls natural disturbance up, but is not present for all species.
