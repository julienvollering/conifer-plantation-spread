...
To minimize spillover effects on native ecosystems, land managers need to know which ecosystems are most and least susceptible to establishment of "wildling" offspring of a given species.
The spatial distribution of wildlings around plantations is an early and therefore valuable indicator of ecosystem susceptibility to wildling establishment, but various contingencies --- where plantations were sited, for example --- complicate direct comparisons between ecosystems.
...
We modeled the spatial distribution of wildling abundance as a function of the spatial distribution of ecosystems, adjusting for other influences on wildling abundance at surveyed locations, especially the amount of seed rain from plantation stands.
~~We modeled the spatial distribution of wildlings that have reached a specified height as a function of the spatial distribution of ecosystems, adjusting for other influences on wildling abundance at surveyed locations, especially the amount of seed rain from the plantation.~~
~~We compared across ecosystems how many wildlings have established and grown to a specified height, adjusting for other influences on wildling abundance at a particular location, especially the amount of seed rain from the plantation.~~
...
These differences were partly dampened by factors like seed rain, and therefore less apparent in the observed spatial distribution of wildling abundance.
~~For all species groups, wildling abundance increased by about three orders of magnitude from the least to the most susceptible ecosystems, all else being equal.~~
~~We found that, for all species groups, relative establishment likelihood spanned at least three orders of magnitude between the most and least susceptible ecosystems.~~
4. Agricultural ecosystems were consistently among the ecosystems least susceptible to wildling establishment. 
...
For example, any new plantation should be sited where its surroundings are relatively less susceptible to wildlings.
Conversely, any control efforts should be especially mindful of places with more susceptible ecosystems.
~~At the critical early stages of alien conifer naturalization, the spatial distribution of wildling abundance around plantations is a valuable indicator of ecosystem susceptibility to wildling establishment.~~
~~Ecosystem susceptibility to wildling establishment can be inferred from the spatial distribution of wildling abundance around plantations and, in turn, inform management of alien conifer spread.~~
~~Ecosystem susceptibility to wildling establishment, inferred from the spatial distribution of wildling abundance around plantations, informs management of alien conifer spread at the critical early stages of naturalization.~~
~~Management of alien conifer spread can be informed by differences in ecosystem susceptibility to wildling establishment, observed in the introduced range.~~
~~Management of alien conifer spread is informed by differences in ecosystem susceptibility to wildling establishment, which can be inferred from the spatial distribution of wildling abundance around plantations.~~
~~Management of alien conifer species should be informed by how susceptible different ecosystems in the introduced range are to wildling establishment.~~
