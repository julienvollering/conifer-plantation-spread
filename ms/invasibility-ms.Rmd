...
Reducing establishment is of particular interest because it directly regulates wildling abundance (by comparison, reducing dispersal regulates wildling abundance through negative density dependence only, all else being equal). 
...
To estimate from observed wildlings how likely they are to establish in particular ecosystem types, we must account for (1) seed dispersal [@catfordQuantifyingLevelsBiological2012], and (2) sources of variation in establishment beside ecosystem type.
...
Properly quantified establishment likelihoods can be used to predict how vulnerable the surroundings of an unobserved plantation are, based on its composition of ecosystem types.
