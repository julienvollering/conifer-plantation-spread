...
3. In total, across...(ha of surveyed ecosystems) we found...(areal density of wildlings per species).
...
5. *Synthesis and applications* The spatial distribution of self-sown alien conifers around plantations is a valuable indicator of ecosystem susceptibility to establishment and growth at the critical early stages of naturalization. 
We encourage managers to exploit the large differences in susceptibility between ecosystems to reduce the spread of alien conifers. 
New plantations should be sited where surrounding ecosystems are less susceptible to wildlings, and efforts to control wildlings should pay close attention to susceptible ecosystems---even if these are not exposed to high levels of seed rain directly from plantations.
...
Afforestation programs proposed for climate change mitigation and other benefits may also include alien species [@brightEvaluatingTerrestrialCarbon2020, @teururakaunewzealandforestserviceOneBillionTrees2018].
...
*We want to prevent wildlings from plantations*
...
Alien conifer invasions have proven damaging and costly in many parts of the world, and it is prudent to prevent the initial spread from plantations --- both to protect the integrity of surrounding ecosystems and to block secondary, potentially invasive spread [@nunezEcologyManagementInvasive2017].
...
It is prudent to prevent the spread of self-sown individuals --- or "wildlings" --- because they threaten the integrity of existing ecosystems.
Where alien conifers species are planted, their spread into surroundings should be prevented.
It is prudent to prevent the spread of self-sown individuals, or wildlings, from plantations, as these often harm biodiversity and other values.
In many instances these self-sown individuals, or wildlings, harm biodiversity and other values.
Preventing escape from plantations safeguards plantation surroundings and also blocks secondary, potentially invasive spread.

Offspring from alien conifer plantations frequently establish outside the boundaries of the plantation [@nunezEcologyManagementInvasive2017].
Alien conifer plantations generally produce self-sown individuals outside plantation boundaries, and these often threaten the integrity of existing ecosystems. 

*Wildlings establish in some ecosystems more readily than others* 
Naturally, wildlings establish in some ecosystems more readily than others.
More or less favorable conditions depending on the autecology of the conifer species.
Assessing which ecosystems are most susceptible is an urgent priority.

The spatial distribution of wildlings around a plantation varies a lot from site to site, even among conspecific stands of similar age [@fernandesWhatDrivesEucalyptus2018; @nygaardSpreadIntroducedSitka2017], which suggests that surrounding ecosystems are not equally invasible.
To better understand this variation, we need to consider the processes of dispersal establishment (germination and growth), which jointly generate patterns of wildling abundance in space.
Plantation conifers generally have wind-vectored seed dispersal, which has received significant research attention and can be reconstructed with relative confidence [@nathanDispersalKernels2012].
...
The susceptibility of plantation surroundings may be manipulated retrospectively through interventions around existing plantations or prospectively through plantation site selection.
...
*Assess establishment across what?*
...
*Conifer plantations as invasion science experiments*
...
- What is the relative susceptibility of ecosystems neighboring alien conifer wildlings in Norway?
- How susceptible to wildling establishment are the ecosystems that neighbor alien conifer plantations in Norway?
- How much do ecosystems vary in their susceptibility to alien conifer wildlings?
