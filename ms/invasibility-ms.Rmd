...
For our second analysis --- isolating the effect of ecosystem type on establishment likelihood --- we needed estimates of the spatial distribution of seed deposition within the 500x500 m field plots.
...
Sitka/Lutz spruce and Norway spruce did not colonized disturbance-structured ecosystem types at a higher rate than ecosystem types without disturbance structuring.
...
Limitation: WALD model of seed deposition fits patterns of *establishment* better than ExP, but we cannot strictly test if it was a better descriptor of seed dispersal specifically. Survivorship bias. See different definitions of seed dispersal kernel in Nathan. What processes other than dispersal could give WALD a better fit to establishment than ExP?   
