...
Two models (larches without seed rain and lodgepole pine with static dispersal kernel) did not converge and were excluded from selection.
...
\newpage
\blandscape
```{r establishment-hypotheses, fig.cap="Relative densities (unfilled points) and relative establishment likelihoods (filled points) of four alien conifer species groups among categories of ecosystem types (top) or structuring processes in ecosystem types (bottom). Relative establishment likelihoods are shown with 95 % confidence intervals. The horizontal dotted lines indicate the reference strata."}
