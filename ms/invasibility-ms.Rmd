---
title: 'Agricultural ecosystems are least susceptible to alien conifer spread in Norway'
author:
...
To reduce the burden plantations impose on native ecosystems, land managers need to know which ecosystems are most and least susceptible to establishment of "wildling" offspring of each plantation species.
~~To slow the spread of alien conifers and reduce the burden of their plantations on native ecosystems, land managers need to know which ecosystems are most and least susceptible to establishment of these species.~~
~~To slow the escape of plantation offspring and reduce the burden plantations impose on native ecosystems, managers need to know which ecosystems are most and least susceptible to establishment of these species.~~
~~Land managers need to know which ecosystems are most and least susceptible to establishment of plantation offspring --- so-called "wildlings" --- to slow alien spread and reduce the burden of plantations on native ecosystems.~~
~~To slow offspring escaping plantation boundaries and burdening native ecosystems, managers need to know which ecosystems are most and least susceptible to establishment of so-called "wildlings."~~
Wildling abundance around plantations can be used to infer ecosystem susceptibility to wildling establishment at an early stage of spread, but various contingencies --- where plantations were planted, for example --- complicate direct comparisons between ecosystems.
~~Wildling abundance around plantations can be used to infer ecosystem susceptibility to wildling establishment at an early stage of spread, but various contingencies --- where plantations were planted, for example --- make it harder to compare ecosystems on equal footing.~~
~~Wildling abundance around plantations can be used to infer ecosystem susceptibility to wildling establishment at an early stage of spread, but various contingencies --- where plantations were planted, for example --- impede fair comparison between ecosystems.~~
~~Wildling abundance around plantations can be used to infer ecosystem susceptibility to wildling establishment at an early stage of spread, but it does not reflect susceptibility directly because contingencies --- like plantation locations --- also affect the observed pattern of colonization.~~   
~~Although we can readily observe differences in wildling abundance across the ecosystems surrounding plantations, these do not directly reflect ecosystem susceptibility, because contingencies --- like plantation locations --- also affect the observed pattern of colonization.~~
~~Although readily observable, wildling abundance is not a direct measure of ecosystem susceptibility, because contingent factors like proximity to plantations also shape the realized pattern of ecosystem colonization.~~ 
2. We compared across ecosystems how frequently wildlings establish and grow to a given height, studying three groups of alien conifer species in Norway. We used data from detailed surveys around 76 plantation stands to model the effect of ecosystem type on wildling abundance, adjusting for other influences on wildling abundance at a given location, especially seed rain.
3. We found that, for all species, relative establishment likelihood spanned at least three orders of magnitude between the most and least susceptible ecosystems. 
For all species, wildling abundance increased by about three orders of magnitude between the least to the most susceptible ecosystems, all else being equal. 
We found that agricultural ecosystems were consistently among the ecosystems that suppressed wildling establishment and growth most. 
Agricultural ecosystems were consistently among the least susceptible to wildling establishment and growth (as represented by the abundance of tall wildlings), although they were relatively less resistant to establishment alone (as represented by the abundance of short wildlings). 
4. *Synthesis and applications* Management of alien conifer species should be informed by differences in ecosystem susceptibility to wildling establishment and growth observed in the introduced range. In case of ongoing planting, plantation stands should be sited where their surroundings are relatively insusceptible to wildlings. In Norway, stands hemmed in by agriculture are likely to spawn wildlings at rates orders of magnitude lower than stands surrounded by more susceptible ecosystems. In case of ongoing naturalization, managers should be aware that early patterns of wildling colonization may be a poor indicator of long-term susceptibility.
...
In particular, plantations that contribute to the presence of alien conifers in protected areas may generate substantial control costs [@mcconnachieEstimatingEffectPlantations2015].
...
The number of wildlings and their distance from the nearest plantation stand varies a lot from site to site, even among conspecific stands of similar age [@fernandesWhatDrivesEucalyptus2018; @nygaardSpreadIntroducedSitka2017], which makes it hard to predict and manage their spread.
...
Stands of wind-dispersed, alien conifers present a unique opportunity to assess ecosystem invasibility (to these species), because we can estimate ecosystem exposure (seed rain) directly, rather than by proxy [@catfordQuantifyingLevelsBiological2012]. 
We examine plantations of alien conifers in Norway to investigate the following questions:

1. How much does wildling establishment likelihood differ from surveyed wildling density across ecosystems?
