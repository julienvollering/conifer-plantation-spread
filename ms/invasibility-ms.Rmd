...
How many wildlings are present and how far they are from the plantation varies a lot from site to site, even among conspecific plantations of similar age [@fernandesNaturalRegenerationPinus2016; @nygaardSpreadIntroducedSitka2017], which makes it harder to predict and manage their spread.
...
Thus, we did not find any broad commonalities between vulnerable ecosystems that might help guide wildling management. 
