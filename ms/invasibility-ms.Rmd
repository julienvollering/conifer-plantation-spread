...
As a result, it encapsulates in its ecosystem types much of the variation that is most likely to regulate wildling germination and survival --- in competition, hydrology, disturbance, and the like [refs].
Furthermore, it allows us to generalize establishment likelihood beyond specific, observed areas and to project it to unobserved areas.   
...
For example, low establishment likelihood in an area close to the plantation can be masked by high seed rain there [@rougetInferringProcessPattern2003].
...
4. Beyond their influence on ecosystem type, how do climate and topography affect the likelihood of wildling establishment?
