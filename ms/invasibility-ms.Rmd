...
1. Plantations of alien conifer species are common in many countries and may become even more prevalent in coming decades, as a way to sequester carbon.
...
2. We used data from detailed surveys around 76 plantation stands in Norway to estimate ecosystem susceptibility to three groups of commonly planted conifer species: *Picea sitchensis*/*P.* $\times$ *lutzii*, *P. abies*, and *Larix* spp.
We created spatially explicit models of wildling abundance as a function of ecosystem identity, exposure to seed rain, climate, and plantation stand characteristics.
3. In total, across...(ha of surveyed ecosystems) we found...(areal density of wildlings per species).
For all three conifer species groups, we found that ecosystem identity was responsible for differences in wildling abundance of up to three orders of magnitude.
...
5. *Synthesis and applications* The spatial distribution of wildling abundance around plantations is a valuable indicator of ecosystem susceptibility to wildling establishment at the critical early stages of alien conifer naturalization. 
...
New plantations should be sited where surrounding ecosystems are less susceptible to wildlings, and efforts to control wildlings should pay close attention to susceptible ecosystems---irrespective of how exposed they are in the early stages of naturalization.
...
~~We also found that relative ecosystem susceptibility changed depending on which height class of wildlings we counted (≥ 30 cm or $≥ 100 cm), suggesting that some ecosystems are relatively more conducive to establishment than growth, and vice versa.~~
~~We also found that relative ecosystem susceptibility changed depending on which height class of wildlings we counted (≥ 30 cm or $≥ 100 cm), showing which ecosystems are more conducive to establishment than growth and vice versa.~~

# Keywords

alien species, conifer, establishment likelihood, invasibility, plantation, seed dispersal, Wald Analytical Long-distance Dispersal (WALD)
...
Afforestation is widely proposed for climate change mitigation and other benefits, and afforestation programs may include planting alien species [@brightEvaluatingTerrestrialCarbon2020, @teururakaunewzealandforestserviceOneBillionTrees2018].

*We want to prevent wildlings from plantations*
Plantations of alien conifers are widespread globally, and offspring from these plantations frequently establish in surrounding areas [@nunezEcologyManagementInvasive2017].
In many instances these naturalized offspring, or wildlings, harm biodiversity and other values, so curbing their spread is prudent.
For example, pine invasions in protected areas in South Africa generate substantial control costs, and most can be directly attributed to nearby plantations [@mcconnachieEstimatingEffectPlantations2015].
...
Accordingly, guidelines for sustainable use of alien trees emphasize that restricting trees to the areas set aside for their cultivation is fundamental to good forestry practice [@brunduGlobalGuidelinesSustainable2020].
...
JV, SLO, and OSk conceived the ideas and designed methodology; SLO, LA, MOK, AO, JS, OSt, and ØS collected the data; JV analyzed the data and led the writing.
