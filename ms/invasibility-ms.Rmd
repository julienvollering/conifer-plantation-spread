...
1. Plantations of alien conifer species are common worldwide, and set to become even more prevalent in coming decades.
To minimize spillover from plantations into native ecosystems, land managers need to know which ecosystems are most and least susceptible to establishment of "wildling" offspring of a given species.
The spatial distribution of wildlings near plantations is an early and therefore valuable indicator of ecosystem susceptibility to wildling establishment, but it is also shaped by the spatial distribution of seed rain, among other factors.
2. We used data from detailed surveys around 76 plantation stands in Norway to estimate ecosystem susceptibility to three groups of commonly planted conifer species.
We created a spatially explicit model of wildling abundance as a function of ecosystem identity, exposure to seed rain, climate, and plantation stand characteristics.
3. For all three conifer species groups, we found that ecosystem identity was responsible for differences in wildling abundance of up to three orders of magnitude.
Stratifying wildlings by height, we also found evidence that some ecosystems may be more conducive to establishment than growth, and vice versa.
4. Various kinds of agricultural ecosystems were among the ecosystems least susceptible to wildling establishment of all three groups of conifer species. 
5. *Synthesis and applications* 
The spatial distribution of wildling abundance around plantations is a valuable indicator of ecosystem susceptibility to wildling establishment at the critical early stages of alien conifer naturalization.
...
~~The distribution of wildlings near plantations is an early and therefore valuable indicator of how likely wildlings are to establish and grow in different ecosystems, but it is also strongly shaped by the spatial distribution of seed rain, among other factors.~~
~~The rank susceptibility of ecosystems deviated strongly from the distribution of wildlings across ecosystems, owing to influences like exposure to seed rain.~~
...
Studying ecosystem invasibility is tractable with plantations of alien conifers because their seeds are wind-dispersed, 
Alien conifer plantations are a system in which it is tractable to study ecosystem invasibility (to these species), because we can estimate ecosystem exposure to wind-dispersed seeds from plantations with some confidence [@catfordQuantifyingLevelsBiological2012]. 
...
1. How much do ecosystems vary in their susceptibility to alien conifer wildlings, and
...
Data will be made available via the Dryad Digital Repository. Code is available at <https://github.com/julienvollering/conifer-plantation-spread>.
