...
Accordingly, we applied zero-inflated generalized linear models, which regard zeros as the mixed product of a binomial process as well as a (conditional) count process.
