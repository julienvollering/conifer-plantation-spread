...
Moreover, microsites are known to regulate conifer recruitment strongly [@macekLifeDeathPicea2017], so ecosystem types that are ostensibly inhospitible may actually contain many suitable microsites.
