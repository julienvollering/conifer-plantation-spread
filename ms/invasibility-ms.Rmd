...
Moreover, seedling mortality is strongly regulated by microsites  [@macekLifeDeathPicea2017], so ecosystem types that would seem inhospitible at first glance may actually contain many localized opportunities for establishment.
From this perspective, our estimates of establishment probability measure the density of suitable microsites in a given ecosystem type, which may be treated as constant even if their fine-scale spatial distribution is not.
...
Previous work on invasive species suggests that the establishment patterns we quantify for four species are likely to hold, more or less, in other countries [@chytryHabitatInvasionsAlien2008].
From a manager's perspective, we expect that the ecosystem types we report may translate well to equivalent types in similar classification systems, because Nature in Norway classification is rule-based and aims for observer neutrality. 
...
Additional insight could be gleaned from a study like ours if wildling growth rates were measured in the field.
...
Abundant but slow colonization may be of lesser concern than sparse but fast colonization, depending on objectives.

A curious feature of our results that needs more research to understand is the large variation in Sitka/Lutz spruce establishment likelihood between sites --- much larger than in the other species.
Consequently, our ability to predict the magnitude of Sitka/Lutz spruce spread at a specific site, relative to other sites, is limited. 
...
Alternative explanations could include: (1) property owners removing wildlings at some sites --- especially since Sitka/Lutz spruce spread has attracted public attention in recent years, or (2) differing demographic characteristics among plantations [@taylorDriversPlantInvasion2016] --- potentially as a result of provenance. 
