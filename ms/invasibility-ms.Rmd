...
Surprisingly, wildling abundance did not increase with plantation age, although areas around younger plantations were more likely to be free of wildlings.
Explanations for this result could include lower survival rates in older wildlings, or a quick saturation of suitable microsites.
Negative effects of the interaction between relative seed rain and plantation age (in larch and lodgepole pine) could theoretically be explained by secondary seed production, which changes the shape of the seed shadow as the plantation grows older, but in the field we observed little indication of significant seed production from wildings.
...
Lodgepole pine was found to respond strongly to both temperature and precipitation, but our six sites provide too weak footing for estimating these effects.
Specifically, the sites were geographically clustered with a Pearson correlation of 0.98 between climatic variables, and 93% of wildlings occurred at the inland sites.
