...
3.  Our surveys registered 28 wildlings per hectare for *P. sitchensis* / *P.*
    $\times$ *lutzii* ($\frac{24013}{860}$ ha^-1^), 6 ha^-1^ for *P. abies*
    ($\frac{2277}{396}$ ha^-1^), and 13 ha^-1^ for *Larix*
    spp.($\frac{4287}{318}$ ha^-1^). For all three species groups, we found that
