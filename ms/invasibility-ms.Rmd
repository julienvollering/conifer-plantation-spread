...
Naturally, variation in establishment likelihoods shrank when ecosystem types were aggregated (by category or structuring process; fig. \@ref(fig:establishment-hypotheses)).
...
Yet despite larger sample sizes, the mean establishment likelihood in a given group was rarely clearly distinguishable from that in other groups.
