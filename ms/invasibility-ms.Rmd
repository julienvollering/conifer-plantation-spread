...
invasibility, seed rain, disturbance, plantation, conifer
...
However, the number of wildlings that establish and their distances from the plantation vary a lot from site to site, even within species [@nygaardSpreadIntroducedSitka2017; @fernandesWhatDrivesEucalyptus2018], which makes it harder to manage wildling spread.

The process that generates wildling spread --- and variation therein --- consists of dispersal and establishment (where establishment denotes both germination and survival).
The number of wildlings observed in an area depends on how many seeds arrived there and how likely the seeds were to establish.
Establishment likelihood is of great interest to managers because... 
...
Limitation: wildling establsihment varies not only in number and distance but also in growth rate across ecosystem types. Abundant but slow colonization may be of lesser concern than sparse but fast colonization, depending on management objectives.
