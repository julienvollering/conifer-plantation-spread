...
Within species, confidence intervals on establishment probabilities in pairs of ecosystem types frequently overlapped.
...
For example, it is not clear whether the establishment probability of lodgepole pine is higher in the "coastal heath" or "bare rock" types, but it is obviously much higher in both of these than in "forest".
...
For example, the model predicts that "arable fields" at the locality with the highest overall establishment probability and "boreal heath" at the locality with the lowest overall establishment probability would be colonized at roughly equal rates, even though "boreal heath" is colonized more than 100 times faster on average.
