...
```{r relative establishment, fig.cap="Ecosystem types without wildlings and covering less than 0.5 ha across the species data set are not displayed. Photos licensed CC BY 4.0 Rune Halvorsen."}
