...
2. We compared how likely wildlings are to establish across a wide range of ecosystem types, focusing on four groups of alien conifer species planted in Norway. We used data from detailed surveys around 82 plantations to model the relationship between ecosystem type and wildling abundance --- accounting for seed rain, climate, and other sources of variation between sites. Further, we checked whether differences in vulnerability between individual ecosystem types could be generalized based on broad, shared characteristics.
...
JV, SLO, and OSk conceived the ideas and designed methodology; LA, MOK, AO, SLO, JS, OSk(?), OSt, ØS, and SET collected the data; JV analysed the data and led the writing of the manuscript. All authors contributed critically to the drafts and gave final approval for publication.

# Acknowledgements

We thank Honorata Gajda, Knut Børge Strøm, Heidi Elin Myklebost, Jon Hagelin, Monica Ruano, Vigdis Frivoll, Matteo De Stefano, Sina Thu Randulff, Roy Mangersnes, Bjarne Homnes Oddane, Rune Søyland, Toralf Tysse, Craig Jackson
Miene-Marie Gastinger, Ola Westby Aamodt, and Anders Ringstad for collecting field data.
