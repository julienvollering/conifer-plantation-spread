...
We fitted three parallel models for each species: (1) with relative seed rain derived from the empirical dispersal kernel, (2) with relative seed rain derived from the WALD dispersal kernel, and (3) without relative seed rain.
...
For all species, models using relative seed rain estimates from the WALD dispersal kernel predicted wildling abundance best (Appendix, table \@ref(tab:model-comparison-table)).
...
The association between structuring process and establishment likelihood was heterogenous across species.
Nevertheless, ecosystems structured by destabilizing disturbance tended to show higher establishment likelihoods than those structured by environmental stress and those without disturbance structuring.
...
This means that our ability to predict the spread of these species at a specific site, relative to other sites, is still limited (even if the site's ecosystem composition is known). 
Even so, ecosystem comparisons can guide management.
