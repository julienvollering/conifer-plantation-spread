...
In the areas we mapped, the total wildling density of each species is congruent with assessments of their invasion potential by the Norwegian impact assessment of alien species, which scored larches one level less invasive than lodgepole pine and Sitka/Lutz spruce [@Fremmedartslista2018; @sandvikGenericEcologicalImpact2019]. 
...
Nevertheless, Sitka/Lutz spruce also established in 'open shallow-soil ground' with very high likelihood, despite this ecosystem type's characteristically dry soil.  
...
Long distance dispersal might preclude complete containment [@albertLanduseChangeSubalpine2008], but reductions in the number of wildlings by orders of magnitude are likely. 
...
Additional insight could be gleaned from a study like ours if wildling growth rates were quantified.
Field observations of interwhorl distances suggest that individuals in different locations grew taller at very different rates.  
...
One conspicuous and curious feature of our results was that Sitka/Lutz spruce establishment likelihood varied greatly from site to site --- much more than for other species.
This implies that our ability to predict the magnitude of Sitka/Lutz spruce spread at a specific site, relative to other sites, is limited. 
Our ecosystem comparison can nevertheless guide managment.
...
More research is needed to probe this unexplained site-level variation.
...
This suggests that the unexplained site-level variation we observed was not caused by differences in the densities of seed sources (which would violate our model assumptions).
Possible there are demographic differences between sites for unknown reasons [@taylorDriversPlantInvasion2016]. (human action? provenance?) Shows the continued need for monitoring.  also struggle to predict regeneration density from: density of the seed source, the age of the seed source, moss cover, or bare ground cover. 
