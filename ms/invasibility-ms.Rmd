...
2. We compare how likely conifer wildlings are to establish across a wide range of ecosystem types, focusing on four groups of alien species planted in Norway. We use data from detailed surveys around 82 plantations to model the relationship between ecosystem type and wildling abundance --- accounting for seed rain, climate, and other sources of variation between sites. Further, we check whether differences in vulnerabilty between individual ecosystem types can be generalized, based on broad-brush characteristics used to classify ecosystem types.
3. We found that conifer wildlings were several orders of magnitude more likely to establish in the most vulnerable ecosystem types than in the least vulnerable ecosystem types. This range of variation from our models was larger than the range of variation in the raw densities of wildlings across ecosystem types. Accounting for seed rain, climate, and site variation also changed the rank vulnerabilities of ecosystem types. 
4. The four groups of conifer species showed modestly similar patterns of establishment likelihood across ecosystem types, with some agricultural ecosystem types repeatedly among the least vulnerable. However, broad hydrological and disturbance characteristics of ecosystem types did not summarize patterns of vulnerability well. 
6. *Synthesis and applications* Wider implications and relevance to management, synthesis of the paper's key messages, generic, seminal and accessible to non-specialists. Our results... Managers should be careful not to conflate an ecosystem type's density of alien species with its vulnerability to these species, relative to other ecosystem types. Managers should not assume that ostensibly similar ecosystems are equally or even similarly vulnerable.  ...restrict new plantations to low-risk sites, design efficient monitoring, and target interventions.
...
Alternative explanations could include: (1) property owners removing wildlings at some sites (2) differing demographic characteristics among plantations [@taylorDriversPlantInvasion2016] --- potentially as a result of provenance. 
...
Thus, we did not find any broad commonalities between vulnerable ecosystems that could help guide wildling management. 
