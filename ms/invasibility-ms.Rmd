...
We compared the frequency with which four groups of exotic conifers establish in various nature types, using observational data. 
Specifically, we used observations of wildlings and nature types, mapped around sexually mature plantations from which the wildlings presumably originated.
We analysed the data in two ways, to answer distinct questions about differences in establishment.

The first analysis was a simple tallying of the number of wildlings of each conifer per unit area of each nature type.
...
In the tallying analysis, variation in the density of wildlings from is partly attributable to differences between conifers and between nature types, and partly to contingent factors, such as the spatial distribution of nature types around plantations. 
The motivation for this approach was to break down the realised spread of wildlings at the specific localities in the data set --- to give a picture of the current status of the naturalization process.
