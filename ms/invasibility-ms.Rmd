...
To reduce the burden plantations impose on native ecosystems, land managers need to know, for a given species, which ecosystems are most and least susceptible to establishment of "wildling" offspring.
The spatial distribution of wildlings around plantations is an early indicator of ecosystem susceptibility to wildling establishment, but various contingencies --- where plantations were planted, for example --- complicate direct comparisons between ecosystems.
