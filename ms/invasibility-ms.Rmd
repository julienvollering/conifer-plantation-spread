...
Also see Equation \@ref(eq:estmod).
...
Its structure mandated that --- to estimate how ecosystem type affects wildlings --- our model adjust for climate, relative elevation, seed deposition density, and locality [ @textorRobustCausalInference2016; @mcelreathHauntedDAGCausal2020].
...
Plantation age was included in the model because the observed wildlings were accrued over the lifetime of the plantation.
