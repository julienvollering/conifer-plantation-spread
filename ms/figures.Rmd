...
g1 <- ggplot(data = d, mapping = aes(x = type)) + 
  ...
  geom_vline(xintercept = which(levels(d$type) == 'forest'), linetype = "dashed") +
  geom_point(data = filter(d, modeled == TRUE, !is.na(locality)),
             mapping = aes(y = fit), color = 'grey', alpha = 0.5, pch = 20,
             position = position_jitter(width = 0.1)) +
  geom_linerange(mapping = aes(ymin = ci.l, ymax = ci.u), color = 'blue') +
  geom_point(data = filter(d, modeled == TRUE, is.na(locality)),
             mapping = aes(y = fit), color = 'blue') +
...
g2 <- ggplot(data = d, mapping = aes(x = type)) + 
  ...
  geom_point(data = filter(d, modeled == TRUE, !is.na(locality)),
             mapping = aes(y = fit), color = 'grey', alpha = 0.5, pch = 20,
             position = position_jitter(width = 0.1)) +
  geom_linerange(mapping = aes(ymin = ci.l, ymax = ci.u), color = 'red') +
  geom_point(data = filter(d, modeled == TRUE, is.na(locality)),
             mapping = aes(y = fit), color = 'red') +
  geom_point(data = filter(d, modeled == FALSE), mapping = aes(y = fit), 
             color = 'red', pch = 1) +
  scale_y_log10(
    breaks = scales::trans_breaks("log10", function(x) 10^x),
...
g3 <- ggplot(data = d, mapping = aes(x = type)) + 
  ...
  geom_point(data = filter(d, modeled == TRUE, !is.na(locality)),
             mapping = aes(y = fit), color = 'grey', alpha = 0.5, pch = 20,
             position = position_jitter(width = 0.1)) +
  geom_linerange(mapping = aes(ymin = ci.l, ymax = ci.u), color = 'purple') +
  geom_point(data = filter(d, modeled == TRUE, is.na(locality)),
             mapping = aes(y = fit), color = 'purple') +
  geom_point(data = filter(d, modeled == FALSE), mapping = aes(y = fit), 
             color = 'purple', pch = 1) +
  scale_y_log10(
    breaks = scales::trans_breaks("log10", function(x) 10^x),
...
g4 <- ggplot(data = d, mapping = aes(x = type)) + 
  ...
  geom_point(data = filter(d, modeled == TRUE, !is.na(locality)),
             mapping = aes(y = fit), color = 'grey', alpha = 0.5, pch = 20,
             position = position_jitter(width = 0.1)) +
  geom_linerange(mapping = aes(ymin = ci.l, ymax = ci.u), color = 'darkgreen') +
  geom_point(data = filter(d, modeled == TRUE, is.na(locality)),
             mapping = aes(y = fit), color = 'darkgreen') +
  geom_point(data = filter(d, modeled == FALSE), mapping = aes(y = fit), 
             color = 'darkgreen', pch = 1) +
  scale_y_log10(
    breaks = scales::trans_breaks("log10", function(x) 10^x),
    labels = scales::trans_format("log10", scales::math_format(10^.x)),
    minor_breaks = NULL) +
